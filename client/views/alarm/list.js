...
Template.alarmList.events({
  'change input[name=showAck]': (event, template) => template.state.set('showAck', event.target.checked),
  'click .js-load-more': (event, template) => template.state.set('limit', template.state.get('limit') + 10),
});