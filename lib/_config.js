...
SOURCE_TYPES = {
  postgres: { value: 'postgres', text: 'PostgreSQL', fields: ['credentials', 'ssl'], mime: 'text/x-pgsql' },
  mysql: { value: 'mysql', text: 'MySQL', fields: ['credentials'], mime: 'text/x-mysql' },
  mssql: { value: 'mssql', text: 'SQL Server', fields: ['credentials', 'mssql'], mime: 'text/x-mssql' },
  impala: { value: 'impala', text: 'Impala', mime: 'text/x-hive' },
};